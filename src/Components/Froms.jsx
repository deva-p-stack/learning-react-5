...
function Forms() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await fetch("https://mimic-server-api.vercel.app/bills", {
        method: "POST", 
        headers: {
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <button
            onClick={addProduct}
            className="py-3 px-5 flex gap-x-1 justify-center items-center w-[50%] mr-3  hover:bg-red-400 bg-red-300 rounded-lg text-md active:scale-95 transition-all duration-300 ease-in-out cursor-pointer " type="button">         
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <button onClick={handleSubmit} className="py-3 px-5 flex gap-x-1 justify-center w-[40%]  items-center  hover:bg-red-400 bg-red-300 rounded-lg text-md active:scale-95 transition-all duration-300 ease-in-out cursor-pointer " type="button">         
